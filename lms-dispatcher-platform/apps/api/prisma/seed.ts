...
function getContent(chapter: number, lesson: number): object {
  const contents: Record<string, object> = {
    ...
    '4-1': {
      ...
      <figure><img src="/img-proxy/wikipedia/commons/f/f0/Person_writing_in_notebook_while_using_laptop_at_a_modern_workspace.jpg" alt="Dispatcher reviewing documents at workstation" /><figcaption>Every load starts and ends with documentation — the dispatcher's daily workflow</figcaption></figure>
      ...
      <figure><img src="/img-proxy/wikipedia/commons/f/f0/Person_writing_in_notebook_while_using_laptop_at_a_modern_workspace.jpg" alt="Диспетчер за рабочим местом с документами" /><figcaption>Каждый рейс начинается и заканчивается документами — ежедневный рабочий процесс диспетчера</figcaption></figure>
...
<figure><img src="/cargo/fig8.png" alt="Gmail notification" /><figcaption>Fig. 8 — Green notification icon (bottom-right): broker replied to your email</figcaption></figure><h3>📋 Load Offer Example — Decoded</h3>
      ...
      <figure><img src="/img-proxy/wikipedia/commons/7/77/Container_loading_with_forklift_at_warehouse_in_Thailand.jpg" alt="Forklift loading palletized cargo" /><figcaption>Understanding pallet counts and weight limits is essential for matching loads to trucks</figcaption></figure>
...
<figure><img src="/cargo/fig8.png" alt="Уведомление Gmail" /><figcaption>Рис. 8 — Зелёная иконка уведомления (правый нижний угол): брокер ответил на ваше письмо</figcaption></figure><h3>📋 Пример оффера — разбор</h3>
    ...
    <figure><img src="/img-proxy/wikipedia/commons/7/77/Container_loading_with_forklift_at_warehouse_in_Thailand.jpg" alt="Погрузка поддонов вилочным погрузчиком" /><figcaption>Понимание паллетных объёмов и весовых лимитов — ключ к правильному подбору груза</figcaption></figure>
...
<li>Release the driver.</li>
      ...
      <figure><img src="/img-proxy/wikipedia/commons/f/f0/Person_writing_in_notebook_while_using_laptop_at_a_modern_workspace.jpg" alt="Dispatcher at workstation managing emails" /><figcaption>Organized email workflow — the key to professional broker relationships</figcaption></figure>`,
...
<li>Отпустите водителя.</li>
    ...
    <figure><img src="/img-proxy/wikipedia/commons/f/f0/Person_writing_in_notebook_while_using_laptop_at_a_modern_workspace.jpg" alt="Диспетчер управляет email за рабочим столом" /><figcaption>Организованный email-процесс — ключ к профессиональным отношениям с брокерами</figcaption></figure>`,
      quiz: {
        questions: [
...
</ul><figure><img src="/img-proxy/wikipedia/commons/b/b4/The_Driver_%2823143217816%29.jpg" alt="Truck driver — your key business partner" /><figcaption>The truck driver — your primary partner. Building trust means building revenue.</figcaption></figure>
...
</ul><figure><img src="/img-proxy/wikipedia/commons/b/b4/The_Driver_%2823143217816%29.jpg" alt="Водитель грузовика — ваш ключевой партнёр" /><figcaption>Водитель — ваш основной партнёр. Построение доверия = построение дохода.</figcaption></figure>
...
<blockquote>Without POD — no payment. This is the most critical document at the end of every load.</blockquote><h3>📞 Load Offer Call Script (30 seconds)</h3>
      ...
      <figure><img src="/img-proxy/wikipedia/commons/f/fa/Bakersfield%2C_%28CA%29_Truck_Peterbilt_at_Flying_J_Travel_Plaza_%286%29.jpg" alt="Truck fleet at Flying J Travel Plaza" /><figcaption>A fleet at a truck stop — managing multiple drivers means managing multiple conversations simultaneously</figcaption></figure>
...
<blockquote>Без POD — нет оплаты. Это самый критический документ в конце каждого груза.</blockquote><h3>📞 Скрипт предложения груза (30 секунд)</h3>
    ...
    <figure><img src="/img-proxy/wikipedia/commons/f/fa/Bakersfield%2C_%28CA%29_Truck_Peterbilt_at_Flying_J_Travel_Plaza_%286%29.jpg" alt="Парк грузовиков на Flying J" /><figcaption>Парк на трак-стопе — управление несколькими водителями = несколько диалогов одновременно</figcaption></figure>
...
<p>Тест охватывает все аспекты общения диспетчера с водителями: отправка, процедуры загрузки, detention, обновления в пути, поломки, доставка и POD. 20 вопросов. Порог прохождения: 18/20.</p>`,
    ...
    '8-1': {
      ...
      <figure><img src="/img-proxy/wikipedia/commons/a/ab/Business_agreement_handshake_at_coffee_shop.jpg" alt="Business handshake — closing a deal" /><figcaption>Every successful bid ends with a deal — your negotiation skills directly determine your income</figcaption></figure>`,
      bodyRu: `
    ...
    <figure><img src="/img-proxy/wikipedia/commons/a/ab/Business_agreement_handshake_at_coffee_shop.jpg" alt="Рукопожатие — закрытие сделки" /><figcaption>Каждый успешный бид заканчивается сделкой — навыки переговоров напрямую определяют ваш доход</figcaption></figure>`,
      quiz: {
        questions: [
